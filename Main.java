...
//        System.out.println(filteredTimeSpan);
        ...
        List<Tweets> filteredWords = filter.containing(tweetsList,Arrays.asList("ruz"));

        //System.out.println("filtered words" + filteredWords);



        //System.out.println(SocialNetwork.findKMostFollower(tweetsList,10));
        SocialNetwork sn = new SocialNetwork();



        // System.out.println(sn.findCliques(tweetsList));
